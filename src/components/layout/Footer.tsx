...
import { Heart, MapPin, Mail, Phone, MessageCircle } from "lucide-react";
...
const socialLinks = [
  { name: "TikTok", href: "https://tiktok.com/@greenai", icon: TikTokIcon },
  { name: "LinkedIn", href: "https://linkedin.com/company/greenai", icon: LinkedInIcon },
  { name: "Instagram", href: "https://instagram.com/greenai", icon: InstagramIcon },
  { name: "Twitter", href: "https://twitter.com/greenai", icon: TwitterIcon },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>Bahnhofstraße 36, 35037 Marburg</span>
            </div>
          ...
          {/* Services Links */}
          <div>
            <h4 className="font-display font-semibold text-foreground mb-4">{t("footer.servicesTitle")}</h4>
            <ul className="space-y-3">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-display font-semibold text-foreground mb-4">{t("footer.getInTouch")}</h4>
            <ul className="space-y-3">
              <li>
                <a
